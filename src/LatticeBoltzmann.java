...
class LatticeBoltzmannDemo extends Canvas implements Runnable, MouseListener, MouseMotionListener {
    ...
    int xdim = 300;				// dimensions of lattice
    int ydim = 150;
    int pixelsPerSquare = 4;	// for graphics
    ...
    Color tracerColor = new Color(23, 21, 120);		// color for drawing tracer particles
    ...
    DoubleScroller barrierSizeScroller = new DoubleScroller("Barrier size = ",1,100,1,20);
    ...
    DoubleScroller contrastScroller = new DoubleScroller("Contrast = ",1,100,1,65);
    ...
    LatticeBoltzmannDemo() {
        ...
        makeLine(40);	// start with a linear barrier
